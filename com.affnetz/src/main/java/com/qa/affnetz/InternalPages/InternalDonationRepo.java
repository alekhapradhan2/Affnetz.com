...
public class InternalDonationRepo {
	...
	private String first_Name="#input-79";
	
	private String last_Name="#input-82";
	
	private String phone_no="#input-85";
	
	private String email_Id="#input-88";
	
	private String donation_filed="#input-96";
