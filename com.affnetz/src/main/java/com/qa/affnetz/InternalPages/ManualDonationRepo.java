...
public class ManualDonationRepo {
	...
	private String phone_no="#input-25";
	
	private String email_Id="#input-28";
	
	private String donation_filed="#input-35";
	
	private String paymentMode="#input-38";
	
	private String paymentModeList="#list-38";
	
	private String allPaymentMode="//div[contains(@id,'list-item-78')]";
	
	private String trnsID="#input-43";
	
	private String address1="#input-51";
	
	private String address2="#input-54";
	
	private String cityName="#input-57";
	
	private String stateClick="#input-60";
	
	private String allStateName="xpath=//div[contains(@id,'list-item-')]";
	
	private String zipCode="#input-70";
