...
public class ManualTributeDonationRepo {
	...
	private String first_Name="#input-83";
	
	private String last_Name="#input-86";
	
	private String phone_no="#input-89";
	
	private String email_Id="#input-92";
	
	private String donation_filed="#input-99";
	
	private String paymentMode="#input-102";
	
	private String paymentModeList="#list-102";
	
	private String allPaymentMode="//div[contains(@id,'list-item-152')]";
	
	private String trnsID="#input-107";
	
	private String address1="#input-124";
	
	private String address2="#input-127";
	
	private String cityName="#input-130";
	
	private String stateClick="#input-133";
	
	private String allStateName="xpath=//div[contains(@id,'list-item-')]";
	
	private String zipCode="#input-143";
